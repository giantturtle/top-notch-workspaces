...
function enable() {
    //global.log("enable TopNotchWorkspaces");
    ...
    Main.panel.addToStatusArea('workspace-indicator', _indicator,0, 'center');
    
    // Move clock, do nothing if the clock isn't centred in this mode
...
function disable() {
    //global.log("disable TopNotchWorkspaces"); 
        //setting horizontal layout
    global.workspace_manager.override_workspace_layout(
        Meta.DisplayCorner.TOPLEFT,
        false,
    ...
    //move clock back,  do nothing if the clock isn't centred in this mode
    if ( Main.sessionMode.panel.center.indexOf('dateMenu') == -1 ) {
        return;
    }
